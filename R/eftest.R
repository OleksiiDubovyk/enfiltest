...
#' @export
eftest_stat <- function(efAICtable){
...
#' @export
eftest <- function(comdata, envdata, npairs = 1000, rep = 1, env_idx, com_idx, trait_idx, taxa_idx, abun_idx = NULL, x_idx, y_idx, trait_FUN, phyl_FUN, phtree, ...){
